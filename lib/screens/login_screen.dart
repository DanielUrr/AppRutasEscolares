                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 10),
                          _buildUserInfo('Conductor', 'conductor@ejemplo.com', 'conductor123'),
                          _buildUserInfo('Padre', 'padre@ejemplo.com', 'padre123'),
                          _buildUserInfo('Admin', 'admin@ejemplo.com', 'admin123'),
                        ],
                      ),
                    ),
                  ),
